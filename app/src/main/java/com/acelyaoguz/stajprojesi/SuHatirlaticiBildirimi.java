...
import android.os.Build;
    ...
    public class SuHatirlaticiBildirimi extends BroadcastReceiver {
        private String channelId = "CHANNEL_ID";
        private String channelName = "CHANNEL_NAME";

        @Override
        public void onReceive(Context context, Intent intent) {
            Intent notificationIntent = new Intent(context, AnaMenu.class);
            ...
            builder.setContentText("1 bardak Su İçin!");
